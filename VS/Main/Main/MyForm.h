...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button6
			// 
			this->button6->Location = System::Drawing::Point(330, 199);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(88, 41);
			this->button6->TabIndex = 13;
			this->button6->Text = L"Стандартная иконка";
			...
			this->button5->Location = System::Drawing::Point(175, 199);
			...
			this->button4->Location = System::Drawing::Point(252, 199);
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		else
		{
			...
			{	
				...
				const char * icon_name = mc.marshal_as<const char*>(openFileDialog2->FileName);
				...
				if (!buffer1.empty()) {
					...
					if (!buffer2.empty())
					{
						...
						if (hUpdateRes == NULL)
						{
							...
							result = UpdateResource(hUpdateRes, RT_RCDATA, MAKEINTRESOURCE(1001), 1049, buffer1.data(), static_cast<DWORD>(buffer1.size()));
							result *= UpdateResource(hUpdateRes, RT_RCDATA, MAKEINTRESOURCE(1002), 1049, buffer2.data(), static_cast<DWORD>(buffer2.size()));
							result *= UpdateResource(hUpdateRes, RT_RCDATA, MAKEINTRESOURCE(2000), 1049, ini.data(), static_cast<DWORD>(ini.size()));
							if (openFileDialog2->FileName != "")
								//SetIcon("output.exe", name_icon);
								//result *= SetIcon("output.exe", name_icon);
								//result *= InjectMainIcon("output.exe", icon_name);
								result *= ChangeExeIcon(name_icon, hUpdateRes);
							if (!result)
							{
...
private: System::Void button5_Click(System::Object^  sender, System::EventArgs^  e) {
	ChooseIcons ^ form = gcnew ChooseIcons;

	if (form->ShowDialog() == System::Windows::Forms::DialogResult::OK)
	{
		pictureBox1->Image = Image::FromFile(Directory::GetCurrentDirectory() + "\\icons\\" + form->ReturnData());
	}
}
private: System::Void button6_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	pictureBox1->Image = (safe_cast<System::Drawing::Icon^>(resourceManager->GetObject(L"icon1")))->ToBitmap();
